...
const Form = () => {
    ...
    const handleSubmit = async e =>{
        ...
        if(user.email === '' || user.senha === ''){
            ...
            await api
                .post('/oficina/login', user)
                .then(resp => {
                    sessionStorage.setItem('user', JSON.stringify(resp.data))
                    navigation('/calendarWorkShop')
                })            
    ...
    return (
        <div className={Styles.form_container}>
            <div className={Styles.text_form}>
                ...
                <p className={Styles.sub_title}>Vamos zerar esses possantes?😉</p>
            </div>
            ...
            <Link className={Styles.link_register} to='/registerWorkshop'>Não tenho conta</Link>
        </div>
    );
}
